...
import 'package:campusbook/ui/authentication/signup/signup_phone_number_verification.dart';
...
class SignupPhoneNumberChooseVerificationPage extends StatefulWidget {
  ...
  const SignupPhoneNumberChooseVerificationPage({Key? key, this.phoneNumber = ''}) : super(key: key);

  @override
  _SignupPhoneNumberChooseVerificationPageState createState() => _SignupPhoneNumberChooseVerificationPageState();
}

class _SignupPhoneNumberChooseVerificationPageState extends State<SignupPhoneNumberChooseVerificationPage> {
    ...
    return Scaffold(
        body: ListView(
          ...
          children: <Widget>[
            ...
            GestureDetector(
              onTap: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => SignupPhoneNumberVerificationPage(verificationType: 'wa', phoneNumber: widget.phoneNumber)));
              },
              child: Card(
                shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(10),
